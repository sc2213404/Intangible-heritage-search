...
if __name__ == '__main__':
    ...
    parser.add_argument('--images_path',
                        ...
                        nargs='?', const='/root/SE_WORK/shenchao/transformed_images', default='/root/SE_WORK/shenchao/transformed_images')
...
def images_to_tfrecord(args):
    ...
    writer = tf.io.TFRecordWriter(args.processed_images_path)
