...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Program evaluating vectors ' \
                                                 'created.')
    parser.add_argument('--image_path', help='Path to image to evaluate ', default="/root/SE_WORK/yuanjunhui/Image-Retrieval-master/images/八大处传说/2.jpg")
